...
Using skills learned from my University courses, I have created a schematic using **KiCAD** where I will test it in real life applications such as UAV and rocketry. A PCB will be displayed here later during the year from the schematic layout. The build will use COTS components such as the Raspberry Pi RP2354A along with a accelerometer and barometer to collect relevant data.
